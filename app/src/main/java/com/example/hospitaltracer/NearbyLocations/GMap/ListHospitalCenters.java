 ...
 *
 */
package com.example.hospitaltracer.NearbyLocations.GMap;
...
import com.example.hospitaltracer.Adapter.CustomPlacesAdapter;
import com.example.hospitaltracer.NearbyLocations.GeometryController;
import com.example.hospitaltracer.HomeActivity;
import com.example.hospitaltracer.R;
...
public class ListHospitalCenters extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital_centers_list);

        /** initializing centers list view to show results of nearby cafe on list */
        ...
        scanButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(ListHospitalCenters.this, e.getMessage(), Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    void listSelection(int i) {
        ...
        dialog.setIcon(R.drawable.mappin);
        dialog.show();
    }
    ...
    void viewMapButton() {
         ...
         * @param MapsActivity
         * */
        Intent intent = new Intent(ListHospitalCenters.this, MapsActivity.class);
        ...
        try {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    GeometryController.manipulateData(ListHospitalCenters.stringBuffer);
                }
            }).start();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    class RetrieveFeedTask extends AsyncTask<StringBuffer, StringBuffer, StringBuffer> {
        ...
        protected StringBuffer doInBackground(StringBuffer... stringBuffers) {
            try {
                ...
                ListHospitalCenters.stringBuffer = buffer;
                return buffer;
