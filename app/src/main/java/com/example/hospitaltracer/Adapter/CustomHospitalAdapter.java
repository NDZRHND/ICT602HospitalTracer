package com.example.hospitaltracer.Adapter;
...
public class CustomHospitalAdapter extends BaseAdapter {
    ...
    /**
     * {@link CustomHospitalAdapter} constructor
     * @param context
     * @param listId
     * @param textViewList
     * */
    public CustomHospitalAdapter(Context context, ArrayList<Integer> listId, ArrayList<String> textViewList) {
